...
```{r Figure2_with_statistical_test, fig.width=10, fig.height=8}
  decon_nnls_extended_all_short_even_shorter %>%
  mutate(
    variable = case_when(
      variable == "Coronary Artery" ~ "Coronary artery",
  ...
  theme(
   ...
   stat_compare_means(comparisons = list(c("STEMI", "NSTEMI"),
                                         c("STEMI", "UA"),
                                         c("STEMI", "Healthy"),
                                         c("NSTEMI", "UA"),
                                         c("NSTEMI", "Healthy"),
                     ...
                     step.increase = 0.2,
                     hide.ns=TRUE)+
# stat_signif(comparisons = list(c("STEMI", "NSTEMI"),
#                                          c("STEMI", "UA"),
#                                          c("STEMI", "Healthy"),
#                                          c("NSTEMI", "UA"),
#                                          c("NSTEMI", "Healthy"),
...
#             )+
 ...
 # stat_pvalue_manual(comparisons = list(c("STEMI", "NSTEMI"), 
 #                                         c("STEMI", "UA"), 
 #                                         c("STEMI", "Healthy"), 
 #                                         c("NSTEMI", "UA"), 
 #                                         c("NSTEMI", "Healthy"), 
 ...
 #                     hide.ns=TRUE)+
  labs(fill = "Group", x = "treatment_descr", 
       y = "Predicted origin of ccfDNA \n[% cells normalised by ccfDNA amount]") +
  facet_wrap(~variable, 
             scale = "free", 
             ncol = 5, 
             labeller = label_wrap_gen(width = 15), 
